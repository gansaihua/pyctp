...
void init_structs(py::module_& m) {
	...
	py::class_<CThostFtdcAuthenticationInfoField>(m, "CThostFtdcAuthenticationInfoField")
		...
		.def("to_dict", [](const CThostFtdcAuthenticationInfoField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["UserID"] = encoding_cast(a.UserID); d["UserProductInfo"] = encoding_cast(a.UserProductInfo); d["AuthInfo"] = encoding_cast(a.AuthInfo); d["IsResult"] = a.IsResult; d["AppID"] = encoding_cast(a.AppID); d["AppType"] = a.AppType; d["ClientIPAddress"] = encoding_cast(a.ClientIPAddress); return d;});
	...
	py::class_<CThostFtdcInstrumentField>(m, "CThostFtdcInstrumentField")
		...
		.def("to_dict", [](const CThostFtdcInstrumentField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InstrumentName"] = encoding_cast(a.InstrumentName); d["ExchangeInstID"] = encoding_cast(a.ExchangeInstID); d["ProductID"] = encoding_cast(a.ProductID); d["ProductClass"] = a.ProductClass; d["DeliveryYear"] = a.DeliveryYear; d["DeliveryMonth"] = a.DeliveryMonth; d["MaxMarketOrderVolume"] = a.MaxMarketOrderVolume; d["MinMarketOrderVolume"] = a.MinMarketOrderVolume; d["MaxLimitOrderVolume"] = a.MaxLimitOrderVolume; d["MinLimitOrderVolume"] = a.MinLimitOrderVolume; d["VolumeMultiple"] = a.VolumeMultiple; d["PriceTick"] = a.PriceTick; d["CreateDate"] = encoding_cast(a.CreateDate); d["OpenDate"] = encoding_cast(a.OpenDate); d["ExpireDate"] = encoding_cast(a.ExpireDate); d["StartDelivDate"] = encoding_cast(a.StartDelivDate); d["EndDelivDate"] = encoding_cast(a.EndDelivDate); d["InstLifePhase"] = a.InstLifePhase; d["IsTrading"] = a.IsTrading; d["PositionType"] = a.PositionType; d["PositionDateType"] = a.PositionDateType; d["LongMarginRatio"] = a.LongMarginRatio; d["ShortMarginRatio"] = a.ShortMarginRatio; d["MaxMarginSideAlgorithm"] = a.MaxMarginSideAlgorithm; d["UnderlyingInstrID"] = encoding_cast(a.UnderlyingInstrID); d["StrikePrice"] = a.StrikePrice; d["OptionsType"] = a.OptionsType; d["UnderlyingMultiple"] = a.UnderlyingMultiple; d["CombinationType"] = a.CombinationType; return d;});
	...
	py::class_<CThostFtdcInstrumentTradingRightField>(m, "CThostFtdcInstrumentTradingRightField")
		...
		.def("to_dict", [](const CThostFtdcInstrumentTradingRightField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InvestorRange"] = a.InvestorRange; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["TradingRight"] = a.TradingRight; return d;});
	...
	py::class_<CThostFtdcInstrumentMarginRateAdjustField>(m, "CThostFtdcInstrumentMarginRateAdjustField")
		...
		.def("to_dict", [](const CThostFtdcInstrumentMarginRateAdjustField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InvestorRange"] = a.InvestorRange; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["HedgeFlag"] = a.HedgeFlag; d["LongMarginRatioByMoney"] = a.LongMarginRatioByMoney; d["LongMarginRatioByVolume"] = a.LongMarginRatioByVolume; d["ShortMarginRatioByMoney"] = a.ShortMarginRatioByMoney; d["ShortMarginRatioByVolume"] = a.ShortMarginRatioByVolume; d["IsRelative"] = a.IsRelative; return d;});
	...
	py::class_<CThostFtdcExchangeMarginRateField>(m, "CThostFtdcExchangeMarginRateField")
		...
		.def("to_dict", [](const CThostFtdcExchangeMarginRateField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["HedgeFlag"] = a.HedgeFlag; d["LongMarginRatioByMoney"] = a.LongMarginRatioByMoney; d["LongMarginRatioByVolume"] = a.LongMarginRatioByVolume; d["ShortMarginRatioByMoney"] = a.ShortMarginRatioByMoney; d["ShortMarginRatioByVolume"] = a.ShortMarginRatioByVolume; d["ExchangeID"] = encoding_cast(a.ExchangeID); return d;});
	...
	py::class_<CThostFtdcTradeField>(m, "CThostFtdcTradeField")
		...
		.def("to_dict", [](const CThostFtdcTradeField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["OrderRef"] = encoding_cast(a.OrderRef); d["UserID"] = encoding_cast(a.UserID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["TradeID"] = encoding_cast(a.TradeID); d["Direction"] = a.Direction; d["OrderSysID"] = encoding_cast(a.OrderSysID); d["ParticipantID"] = encoding_cast(a.ParticipantID); d["ClientID"] = encoding_cast(a.ClientID); d["TradingRole"] = a.TradingRole; d["ExchangeInstID"] = encoding_cast(a.ExchangeInstID); d["OffsetFlag"] = a.OffsetFlag; d["HedgeFlag"] = a.HedgeFlag; d["Price"] = a.Price; d["Volume"] = a.Volume; d["TradeDate"] = encoding_cast(a.TradeDate); d["TradeTime"] = encoding_cast(a.TradeTime); d["TradeType"] = a.TradeType; d["PriceSource"] = a.PriceSource; d["TraderID"] = encoding_cast(a.TraderID); d["OrderLocalID"] = encoding_cast(a.OrderLocalID); d["ClearingPartID"] = encoding_cast(a.ClearingPartID); d["BusinessUnit"] = encoding_cast(a.BusinessUnit); d["SequenceNo"] = a.SequenceNo; d["TradingDay"] = encoding_cast(a.TradingDay); d["SettlementID"] = a.SettlementID; d["BrokerOrderSeq"] = a.BrokerOrderSeq; d["TradeSource"] = a.TradeSource; d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQueryMaxOrderVolumeField>(m, "CThostFtdcQueryMaxOrderVolumeField")
		...
		.def_property("BrokerID", [](const CThostFtdcQueryMaxOrderVolumeField& a) {return encoding_cast(a.BrokerID);}, [](CThostFtdcQueryMaxOrderVolumeField& a, char c[]) {strcpy(a.BrokerID, c);})
		.def_property("InvestorID", [](const CThostFtdcQueryMaxOrderVolumeField& a) {return encoding_cast(a.InvestorID);}, [](CThostFtdcQueryMaxOrderVolumeField& a, char c[]) {strcpy(a.InvestorID, c);})
		.def_property("InstrumentID", [](const CThostFtdcQueryMaxOrderVolumeField& a) {return encoding_cast(a.InstrumentID);}, [](CThostFtdcQueryMaxOrderVolumeField& a, char c[]) {strcpy(a.InstrumentID, c);})
		...
		.def_property("ExchangeID", [](const CThostFtdcQueryMaxOrderVolumeField& a) {return encoding_cast(a.ExchangeID);}, [](CThostFtdcQueryMaxOrderVolumeField& a, char c[]) {strcpy(a.ExchangeID, c);})
		.def_property("InvestUnitID", [](const CThostFtdcQueryMaxOrderVolumeField& a) {return encoding_cast(a.InvestUnitID);}, [](CThostFtdcQueryMaxOrderVolumeField& a, char c[]) {strcpy(a.InvestUnitID, c);})
		.def("to_dict", [](const CThostFtdcQueryMaxOrderVolumeField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["Direction"] = a.Direction; d["OffsetFlag"] = a.OffsetFlag; d["HedgeFlag"] = a.HedgeFlag; d["MaxVolume"] = a.MaxVolume; d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcSyncingInvestorPositionField>(m, "CThostFtdcSyncingInvestorPositionField")
		...
		.def("to_dict", [](const CThostFtdcSyncingInvestorPositionField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["PosiDirection"] = a.PosiDirection; d["HedgeFlag"] = a.HedgeFlag; d["PositionDate"] = a.PositionDate; d["YdPosition"] = a.YdPosition; d["Position"] = a.Position; d["LongFrozen"] = a.LongFrozen; d["ShortFrozen"] = a.ShortFrozen; d["LongFrozenAmount"] = a.LongFrozenAmount; d["ShortFrozenAmount"] = a.ShortFrozenAmount; d["OpenVolume"] = a.OpenVolume; d["CloseVolume"] = a.CloseVolume; d["OpenAmount"] = a.OpenAmount; d["CloseAmount"] = a.CloseAmount; d["PositionCost"] = a.PositionCost; d["PreMargin"] = a.PreMargin; d["UseMargin"] = a.UseMargin; d["FrozenMargin"] = a.FrozenMargin; d["FrozenCash"] = a.FrozenCash; d["FrozenCommission"] = a.FrozenCommission; d["CashIn"] = a.CashIn; d["Commission"] = a.Commission; d["CloseProfit"] = a.CloseProfit; d["PositionProfit"] = a.PositionProfit; d["PreSettlementPrice"] = a.PreSettlementPrice; d["SettlementPrice"] = a.SettlementPrice; d["TradingDay"] = encoding_cast(a.TradingDay); d["SettlementID"] = a.SettlementID; d["OpenCost"] = a.OpenCost; d["ExchangeMargin"] = a.ExchangeMargin; d["CombPosition"] = a.CombPosition; d["CombLongFrozen"] = a.CombLongFrozen; d["CombShortFrozen"] = a.CombShortFrozen; d["CloseProfitByDate"] = a.CloseProfitByDate; d["CloseProfitByTrade"] = a.CloseProfitByTrade; d["TodayPosition"] = a.TodayPosition; d["MarginRateByMoney"] = a.MarginRateByMoney; d["MarginRateByVolume"] = a.MarginRateByVolume; d["StrikeFrozen"] = a.StrikeFrozen; d["StrikeFrozenAmount"] = a.StrikeFrozenAmount; d["AbandonFrozen"] = a.AbandonFrozen; d["ExchangeID"] = encoding_cast(a.ExchangeID); d["YdStrikeFrozen"] = a.YdStrikeFrozen; d["InvestUnitID"] = encoding_cast(a.InvestUnitID); d["PositionCostOffset"] = a.PositionCostOffset; d["TasPosition"] = a.TasPosition; d["TasPositionCost"] = a.TasPositionCost; return d;});
	...
	py::class_<CThostFtdcSyncingInstrumentMarginRateField>(m, "CThostFtdcSyncingInstrumentMarginRateField")
		...
		.def("to_dict", [](const CThostFtdcSyncingInstrumentMarginRateField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InvestorRange"] = a.InvestorRange; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["HedgeFlag"] = a.HedgeFlag; d["LongMarginRatioByMoney"] = a.LongMarginRatioByMoney; d["LongMarginRatioByVolume"] = a.LongMarginRatioByVolume; d["ShortMarginRatioByMoney"] = a.ShortMarginRatioByMoney; d["ShortMarginRatioByVolume"] = a.ShortMarginRatioByVolume; d["IsRelative"] = a.IsRelative; return d;});
	...
	py::class_<CThostFtdcSyncingInstrumentTradingRightField>(m, "CThostFtdcSyncingInstrumentTradingRightField")
		...
		.def("to_dict", [](const CThostFtdcSyncingInstrumentTradingRightField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InvestorRange"] = a.InvestorRange; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["TradingRight"] = a.TradingRight; return d;});
	...
	py::class_<CThostFtdcQryTradeField>(m, "CThostFtdcQryTradeField")
		...
		.def("to_dict", [](const CThostFtdcQryTradeField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["TradeID"] = encoding_cast(a.TradeID); d["TradeTimeStart"] = encoding_cast(a.TradeTimeStart); d["TradeTimeEnd"] = encoding_cast(a.TradeTimeEnd); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryInvestorPositionField>(m, "CThostFtdcQryInvestorPositionField")
		...
		.def("to_dict", [](const CThostFtdcQryInvestorPositionField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryInstrumentMarginRateField>(m, "CThostFtdcQryInstrumentMarginRateField")
		...
		.def("to_dict", [](const CThostFtdcQryInstrumentMarginRateField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["HedgeFlag"] = a.HedgeFlag; d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryInstrumentCommissionRateField>(m, "CThostFtdcQryInstrumentCommissionRateField")
		...
		.def("to_dict", [](const CThostFtdcQryInstrumentCommissionRateField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryInstrumentTradingRightField>(m, "CThostFtdcQryInstrumentTradingRightField")
		...
		.def("to_dict", [](const CThostFtdcQryInstrumentTradingRightField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); return d;});
	...
	py::class_<CThostFtdcQryExchangeOrderField>(m, "CThostFtdcQryExchangeOrderField")
		...
		.def("to_dict", [](const CThostFtdcQryExchangeOrderField& a) {py::dict d; d["ParticipantID"] = encoding_cast(a.ParticipantID); d["ClientID"] = encoding_cast(a.ClientID); d["ExchangeInstID"] = encoding_cast(a.ExchangeInstID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["TraderID"] = encoding_cast(a.TraderID); return d;});
	...
	py::class_<CThostFtdcQryProductField>(m, "CThostFtdcQryProductField")
		...
		.def("to_dict", [](const CThostFtdcQryProductField& a) {py::dict d; d["ProductID"] = encoding_cast(a.ProductID); d["ProductClass"] = a.ProductClass; d["ExchangeID"] = encoding_cast(a.ExchangeID); return d;});
	...
	py::class_<CThostFtdcQryInstrumentField>(m, "CThostFtdcQryInstrumentField")
		...
		.def("to_dict", [](const CThostFtdcQryInstrumentField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["ExchangeInstID"] = encoding_cast(a.ExchangeInstID); d["ProductID"] = encoding_cast(a.ProductID); return d;});
	...
	py::class_<CThostFtdcQryDepthMarketDataField>(m, "CThostFtdcQryDepthMarketDataField")
		...
		.def("to_dict", [](const CThostFtdcQryDepthMarketDataField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); return d;});
	...
	py::class_<CThostFtdcQryExchangeMarginRateField>(m, "CThostFtdcQryExchangeMarginRateField")
		...
		.def("to_dict", [](const CThostFtdcQryExchangeMarginRateField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["HedgeFlag"] = a.HedgeFlag; d["ExchangeID"] = encoding_cast(a.ExchangeID); return d;});
	...
	py::class_<CThostFtdcQryExchangeMarginRateAdjustField>(m, "CThostFtdcQryExchangeMarginRateAdjustField")
		...
		.def("to_dict", [](const CThostFtdcQryExchangeMarginRateAdjustField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["HedgeFlag"] = a.HedgeFlag; return d;});
	...
	py::class_<CThostFtdcOptionInstrMiniMarginField>(m, "CThostFtdcOptionInstrMiniMarginField")
		...
		.def("to_dict", [](const CThostFtdcOptionInstrMiniMarginField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InvestorRange"] = a.InvestorRange; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["MinMargin"] = a.MinMargin; d["ValueMethod"] = a.ValueMethod; d["IsRelative"] = a.IsRelative; return d;});
	...
	py::class_<CThostFtdcQryOptionInstrTradeCostField>(m, "CThostFtdcQryOptionInstrTradeCostField")
		...
		.def("to_dict", [](const CThostFtdcQryOptionInstrTradeCostField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["HedgeFlag"] = a.HedgeFlag; d["InputPrice"] = a.InputPrice; d["UnderlyingPrice"] = a.UnderlyingPrice; d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryOptionInstrCommRateField>(m, "CThostFtdcQryOptionInstrCommRateField")
		...
		.def("to_dict", [](const CThostFtdcQryOptionInstrCommRateField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcIndexPriceField>(m, "CThostFtdcIndexPriceField")
		...
		.def("to_dict", [](const CThostFtdcIndexPriceField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ClosePrice"] = a.ClosePrice; return d;});
	...
	py::class_<CThostFtdcInputExecOrderActionField>(m, "CThostFtdcInputExecOrderActionField")
		...
		.def("to_dict", [](const CThostFtdcInputExecOrderActionField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["ExecOrderActionRef"] = a.ExecOrderActionRef; d["ExecOrderRef"] = encoding_cast(a.ExecOrderRef); d["RequestID"] = a.RequestID; d["FrontID"] = a.FrontID; d["SessionID"] = a.SessionID; d["ExchangeID"] = encoding_cast(a.ExchangeID); d["ExecOrderSysID"] = encoding_cast(a.ExecOrderSysID); d["ActionFlag"] = a.ActionFlag; d["UserID"] = encoding_cast(a.UserID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); d["IPAddress"] = encoding_cast(a.IPAddress); d["MacAddress"] = encoding_cast(a.MacAddress); return d;});
	...
	py::class_<CThostFtdcQryExecOrderField>(m, "CThostFtdcQryExecOrderField")
		...
		.def("to_dict", [](const CThostFtdcQryExecOrderField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["ExecOrderSysID"] = encoding_cast(a.ExecOrderSysID); d["InsertTimeStart"] = encoding_cast(a.InsertTimeStart); d["InsertTimeEnd"] = encoding_cast(a.InsertTimeEnd); return d;});
	...
	py::class_<CThostFtdcQryExchangeExecOrderField>(m, "CThostFtdcQryExchangeExecOrderField")
		...
		.def("to_dict", [](const CThostFtdcQryExchangeExecOrderField& a) {py::dict d; d["ParticipantID"] = encoding_cast(a.ParticipantID); d["ClientID"] = encoding_cast(a.ClientID); d["ExchangeInstID"] = encoding_cast(a.ExchangeInstID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["TraderID"] = encoding_cast(a.TraderID); return d;});
	...
	py::class_<CThostFtdcErrExecOrderField>(m, "CThostFtdcErrExecOrderField")
		...
		.def("to_dict", [](const CThostFtdcErrExecOrderField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExecOrderRef"] = encoding_cast(a.ExecOrderRef); d["UserID"] = encoding_cast(a.UserID); d["Volume"] = a.Volume; d["RequestID"] = a.RequestID; d["BusinessUnit"] = encoding_cast(a.BusinessUnit); d["OffsetFlag"] = a.OffsetFlag; d["HedgeFlag"] = a.HedgeFlag; d["ActionType"] = a.ActionType; d["PosiDirection"] = a.PosiDirection; d["ReservePositionFlag"] = a.ReservePositionFlag; d["CloseFlag"] = a.CloseFlag; d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); d["AccountID"] = encoding_cast(a.AccountID); d["CurrencyID"] = encoding_cast(a.CurrencyID); d["ClientID"] = encoding_cast(a.ClientID); d["IPAddress"] = encoding_cast(a.IPAddress); d["MacAddress"] = encoding_cast(a.MacAddress); d["ErrorID"] = a.ErrorID; d["ErrorMsg"] = encoding_cast(a.ErrorMsg); return d;});
	...
	py::class_<CThostFtdcOptionInstrTradingRightField>(m, "CThostFtdcOptionInstrTradingRightField")
		...
		.def("to_dict", [](const CThostFtdcOptionInstrTradingRightField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InvestorRange"] = a.InvestorRange; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["Direction"] = a.Direction; d["TradingRight"] = a.TradingRight; return d;});
	...
	py::class_<CThostFtdcQryOptionInstrTradingRightField>(m, "CThostFtdcQryOptionInstrTradingRightField")
		...
		.def("to_dict", [](const CThostFtdcQryOptionInstrTradingRightField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["Direction"] = a.Direction; return d;});
	...
	py::class_<CThostFtdcInputForQuoteField>(m, "CThostFtdcInputForQuoteField")
		...
		.def("to_dict", [](const CThostFtdcInputForQuoteField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ForQuoteRef"] = encoding_cast(a.ForQuoteRef); d["UserID"] = encoding_cast(a.UserID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); d["IPAddress"] = encoding_cast(a.IPAddress); d["MacAddress"] = encoding_cast(a.MacAddress); return d;});
	...
	py::class_<CThostFtdcQryForQuoteField>(m, "CThostFtdcQryForQuoteField")
		...
		.def("to_dict", [](const CThostFtdcQryForQuoteField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InsertTimeStart"] = encoding_cast(a.InsertTimeStart); d["InsertTimeEnd"] = encoding_cast(a.InsertTimeEnd); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryExchangeForQuoteField>(m, "CThostFtdcQryExchangeForQuoteField")
		...
		.def("to_dict", [](const CThostFtdcQryExchangeForQuoteField& a) {py::dict d; d["ParticipantID"] = encoding_cast(a.ParticipantID); d["ClientID"] = encoding_cast(a.ClientID); d["ExchangeInstID"] = encoding_cast(a.ExchangeInstID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["TraderID"] = encoding_cast(a.TraderID); return d;});
	...
	py::class_<CThostFtdcInputQuoteActionField>(m, "CThostFtdcInputQuoteActionField")
		...
		.def("to_dict", [](const CThostFtdcInputQuoteActionField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["QuoteActionRef"] = a.QuoteActionRef; d["QuoteRef"] = encoding_cast(a.QuoteRef); d["RequestID"] = a.RequestID; d["FrontID"] = a.FrontID; d["SessionID"] = a.SessionID; d["ExchangeID"] = encoding_cast(a.ExchangeID); d["QuoteSysID"] = encoding_cast(a.QuoteSysID); d["ActionFlag"] = a.ActionFlag; d["UserID"] = encoding_cast(a.UserID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); d["ClientID"] = encoding_cast(a.ClientID); d["IPAddress"] = encoding_cast(a.IPAddress); d["MacAddress"] = encoding_cast(a.MacAddress); return d;});
	...
	py::class_<CThostFtdcQryQuoteField>(m, "CThostFtdcQryQuoteField")
		...
		.def("to_dict", [](const CThostFtdcQryQuoteField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["QuoteSysID"] = encoding_cast(a.QuoteSysID); d["InsertTimeStart"] = encoding_cast(a.InsertTimeStart); d["InsertTimeEnd"] = encoding_cast(a.InsertTimeEnd); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryExchangeQuoteField>(m, "CThostFtdcQryExchangeQuoteField")
		...
		.def("to_dict", [](const CThostFtdcQryExchangeQuoteField& a) {py::dict d; d["ParticipantID"] = encoding_cast(a.ParticipantID); d["ClientID"] = encoding_cast(a.ClientID); d["ExchangeInstID"] = encoding_cast(a.ExchangeInstID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["TraderID"] = encoding_cast(a.TraderID); return d;});
	...
	py::class_<CThostFtdcOptionInstrDeltaField>(m, "CThostFtdcOptionInstrDeltaField")
		...
		.def("to_dict", [](const CThostFtdcOptionInstrDeltaField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InvestorRange"] = a.InvestorRange; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["Delta"] = a.Delta; return d;});
	...
	py::class_<CThostFtdcForQuoteRspField>(m, "CThostFtdcForQuoteRspField")
		...
		.def("to_dict", [](const CThostFtdcForQuoteRspField& a) {py::dict d; d["TradingDay"] = encoding_cast(a.TradingDay); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ForQuoteSysID"] = encoding_cast(a.ForQuoteSysID); d["ForQuoteTime"] = encoding_cast(a.ForQuoteTime); d["ActionDay"] = encoding_cast(a.ActionDay); d["ExchangeID"] = encoding_cast(a.ExchangeID); return d;});
	...
	py::class_<CThostFtdcStrikeOffsetField>(m, "CThostFtdcStrikeOffsetField")
		...
		.def("to_dict", [](const CThostFtdcStrikeOffsetField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InvestorRange"] = a.InvestorRange; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["Offset"] = a.Offset; d["OffsetType"] = a.OffsetType; return d;});
	...
	py::class_<CThostFtdcQryStrikeOffsetField>(m, "CThostFtdcQryStrikeOffsetField")
		...
		.def("to_dict", [](const CThostFtdcQryStrikeOffsetField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); return d;});
	...
	py::class_<CThostFtdcCombInstrumentGuardField>(m, "CThostFtdcCombInstrumentGuardField")
		...
		.def("to_dict", [](const CThostFtdcCombInstrumentGuardField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["GuarantRatio"] = a.GuarantRatio; d["ExchangeID"] = encoding_cast(a.ExchangeID); return d;});
	...
	py::class_<CThostFtdcQryCombInstrumentGuardField>(m, "CThostFtdcQryCombInstrumentGuardField")
		...
		.def("to_dict", [](const CThostFtdcQryCombInstrumentGuardField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); return d;});
	...
	py::class_<CThostFtdcInputCombActionField>(m, "CThostFtdcInputCombActionField")
		...
		.def("to_dict", [](const CThostFtdcInputCombActionField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["CombActionRef"] = encoding_cast(a.CombActionRef); d["UserID"] = encoding_cast(a.UserID); d["Direction"] = a.Direction; d["Volume"] = a.Volume; d["CombDirection"] = a.CombDirection; d["HedgeFlag"] = a.HedgeFlag; d["ExchangeID"] = encoding_cast(a.ExchangeID); d["IPAddress"] = encoding_cast(a.IPAddress); d["MacAddress"] = encoding_cast(a.MacAddress); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); d["FrontID"] = a.FrontID; d["SessionID"] = a.SessionID; return d;});
	...
	py::class_<CThostFtdcCombActionField>(m, "CThostFtdcCombActionField")
		...
		.def("to_dict", [](const CThostFtdcCombActionField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["CombActionRef"] = encoding_cast(a.CombActionRef); d["UserID"] = encoding_cast(a.UserID); d["Direction"] = a.Direction; d["Volume"] = a.Volume; d["CombDirection"] = a.CombDirection; d["HedgeFlag"] = a.HedgeFlag; d["ActionLocalID"] = encoding_cast(a.ActionLocalID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["ParticipantID"] = encoding_cast(a.ParticipantID); d["ClientID"] = encoding_cast(a.ClientID); d["ExchangeInstID"] = encoding_cast(a.ExchangeInstID); d["TraderID"] = encoding_cast(a.TraderID); d["InstallID"] = a.InstallID; d["ActionStatus"] = a.ActionStatus; d["NotifySequence"] = a.NotifySequence; d["TradingDay"] = encoding_cast(a.TradingDay); d["SettlementID"] = a.SettlementID; d["SequenceNo"] = a.SequenceNo; d["FrontID"] = a.FrontID; d["SessionID"] = a.SessionID; d["UserProductInfo"] = encoding_cast(a.UserProductInfo); d["StatusMsg"] = encoding_cast(a.StatusMsg); d["IPAddress"] = encoding_cast(a.IPAddress); d["MacAddress"] = encoding_cast(a.MacAddress); d["ComTradeID"] = encoding_cast(a.ComTradeID); d["BranchID"] = encoding_cast(a.BranchID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryCombActionField>(m, "CThostFtdcQryCombActionField")
		...
		.def("to_dict", [](const CThostFtdcQryCombActionField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryExchangeCombActionField>(m, "CThostFtdcQryExchangeCombActionField")
		...
		.def("to_dict", [](const CThostFtdcQryExchangeCombActionField& a) {py::dict d; d["ParticipantID"] = encoding_cast(a.ParticipantID); d["ClientID"] = encoding_cast(a.ClientID); d["ExchangeInstID"] = encoding_cast(a.ExchangeInstID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["TraderID"] = encoding_cast(a.TraderID); return d;});
	...
	py::class_<CThostFtdcProductExchRateField>(m, "CThostFtdcProductExchRateField")
		...
		.def("to_dict", [](const CThostFtdcProductExchRateField& a) {py::dict d; d["ProductID"] = encoding_cast(a.ProductID); d["QuoteCurrencyID"] = encoding_cast(a.QuoteCurrencyID); d["ExchangeRate"] = a.ExchangeRate; d["ExchangeID"] = encoding_cast(a.ExchangeID); return d;});
	...
	py::class_<CThostFtdcQryProductExchRateField>(m, "CThostFtdcQryProductExchRateField")
		...
		.def("to_dict", [](const CThostFtdcQryProductExchRateField& a) {py::dict d; d["ProductID"] = encoding_cast(a.ProductID); d["ExchangeID"] = encoding_cast(a.ExchangeID); return d;});
	...
	py::class_<CThostFtdcQryForQuoteParamField>(m, "CThostFtdcQryForQuoteParamField")
		...
		.def("to_dict", [](const CThostFtdcQryForQuoteParamField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); return d;});
	...
	py::class_<CThostFtdcForQuoteParamField>(m, "CThostFtdcForQuoteParamField")
		...
		.def("to_dict", [](const CThostFtdcForQuoteParamField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["LastPrice"] = a.LastPrice; d["PriceInterval"] = a.PriceInterval; return d;});
	...
	py::class_<CThostFtdcQryMMOptionInstrCommRateField>(m, "CThostFtdcQryMMOptionInstrCommRateField")
		...
		.def("to_dict", [](const CThostFtdcQryMMOptionInstrCommRateField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); return d;});
	...
	py::class_<CThostFtdcMMInstrumentCommissionRateField>(m, "CThostFtdcMMInstrumentCommissionRateField")
		...
		.def("to_dict", [](const CThostFtdcMMInstrumentCommissionRateField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InvestorRange"] = a.InvestorRange; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["OpenRatioByMoney"] = a.OpenRatioByMoney; d["OpenRatioByVolume"] = a.OpenRatioByVolume; d["CloseRatioByMoney"] = a.CloseRatioByMoney; d["CloseRatioByVolume"] = a.CloseRatioByVolume; d["CloseTodayRatioByMoney"] = a.CloseTodayRatioByMoney; d["CloseTodayRatioByVolume"] = a.CloseTodayRatioByVolume; return d;});
	...
	py::class_<CThostFtdcQryMMInstrumentCommissionRateField>(m, "CThostFtdcQryMMInstrumentCommissionRateField")
		...
		.def("to_dict", [](const CThostFtdcQryMMInstrumentCommissionRateField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); return d;});
	...
	py::class_<CThostFtdcQryInstrumentOrderCommRateField>(m, "CThostFtdcQryInstrumentOrderCommRateField")
		...
		.def("to_dict", [](const CThostFtdcQryInstrumentOrderCommRateField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); return d;});
	...
	py::class_<CThostFtdcFutureLimitPosiParamField>(m, "CThostFtdcFutureLimitPosiParamField")
		...
		.def("to_dict", [](const CThostFtdcFutureLimitPosiParamField& a) {py::dict d; d["InvestorRange"] = a.InvestorRange; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["ProductID"] = encoding_cast(a.ProductID); d["SpecOpenVolume"] = a.SpecOpenVolume; d["ArbiOpenVolume"] = a.ArbiOpenVolume; d["OpenVolume"] = a.OpenVolume; return d;});
	...
	py::class_<CThostFtdcLoginForbiddenIPField>(m, "CThostFtdcLoginForbiddenIPField")
		...
		.def("to_dict", [](const CThostFtdcLoginForbiddenIPField& a) {py::dict d; d["IPAddress"] = encoding_cast(a.IPAddress); return d;});
	...
	py::class_<CThostFtdcIPListField>(m, "CThostFtdcIPListField")
		...
		.def("to_dict", [](const CThostFtdcIPListField& a) {py::dict d; d["IPAddress"] = encoding_cast(a.IPAddress); d["IsWhite"] = a.IsWhite; return d;});
	...
	py::class_<CThostFtdcMarketDataField>(m, "CThostFtdcMarketDataField")
		...
		.def("to_dict", [](const CThostFtdcMarketDataField& a) {py::dict d; d["TradingDay"] = encoding_cast(a.TradingDay); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["ExchangeInstID"] = encoding_cast(a.ExchangeInstID); d["LastPrice"] = a.LastPrice; d["PreSettlementPrice"] = a.PreSettlementPrice; d["PreClosePrice"] = a.PreClosePrice; d["PreOpenInterest"] = a.PreOpenInterest; d["OpenPrice"] = a.OpenPrice; d["HighestPrice"] = a.HighestPrice; d["LowestPrice"] = a.LowestPrice; d["Volume"] = a.Volume; d["Turnover"] = a.Turnover; d["OpenInterest"] = a.OpenInterest; d["ClosePrice"] = a.ClosePrice; d["SettlementPrice"] = a.SettlementPrice; d["UpperLimitPrice"] = a.UpperLimitPrice; d["LowerLimitPrice"] = a.LowerLimitPrice; d["PreDelta"] = a.PreDelta; d["CurrDelta"] = a.CurrDelta; d["UpdateTime"] = encoding_cast(a.UpdateTime); d["UpdateMillisec"] = a.UpdateMillisec; d["ActionDay"] = encoding_cast(a.ActionDay); return d;});
	...
	py::class_<CThostFtdcMarketDataUpdateTimeField>(m, "CThostFtdcMarketDataUpdateTimeField")
		...
		.def("to_dict", [](const CThostFtdcMarketDataUpdateTimeField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["UpdateTime"] = encoding_cast(a.UpdateTime); d["UpdateMillisec"] = a.UpdateMillisec; d["ActionDay"] = encoding_cast(a.ActionDay); return d;});
	...
	py::class_<CThostFtdcSpecificInstrumentField>(m, "CThostFtdcSpecificInstrumentField")
		...
		.def("to_dict", [](const CThostFtdcSpecificInstrumentField& a) {py::dict d; d["InstrumentID"] = encoding_cast(a.InstrumentID); return d;});
	...
	py::class_<CThostFtdcInstrumentStatusField>(m, "CThostFtdcInstrumentStatusField")
		...
		.def("to_dict", [](const CThostFtdcInstrumentStatusField& a) {py::dict d; d["ExchangeID"] = encoding_cast(a.ExchangeID); d["ExchangeInstID"] = encoding_cast(a.ExchangeInstID); d["SettlementGroupID"] = encoding_cast(a.SettlementGroupID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InstrumentStatus"] = a.InstrumentStatus; d["TradingSegmentSN"] = a.TradingSegmentSN; d["EnterTime"] = encoding_cast(a.EnterTime); d["EnterReason"] = a.EnterReason; return d;});
	...
	py::class_<CThostFtdcQryInstrumentStatusField>(m, "CThostFtdcQryInstrumentStatusField")
		...
		.def("to_dict", [](const CThostFtdcQryInstrumentStatusField& a) {py::dict d; d["ExchangeID"] = encoding_cast(a.ExchangeID); d["ExchangeInstID"] = encoding_cast(a.ExchangeInstID); return d;});
	...
	py::class_<CThostFtdcQryInvestorPositionDetailField>(m, "CThostFtdcQryInvestorPositionDetailField")
		...
		.def("to_dict", [](const CThostFtdcQryInvestorPositionDetailField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryCombinationLegField>(m, "CThostFtdcQryCombinationLegField")
		...
		.def("to_dict", [](const CThostFtdcQryCombinationLegField& a) {py::dict d; d["CombInstrumentID"] = encoding_cast(a.CombInstrumentID); d["LegID"] = a.LegID; d["LegInstrumentID"] = encoding_cast(a.LegInstrumentID); return d;});
	...
	py::class_<CThostFtdcCombinationLegField>(m, "CThostFtdcCombinationLegField")
		...
		.def("to_dict", [](const CThostFtdcCombinationLegField& a) {py::dict d; d["CombInstrumentID"] = encoding_cast(a.CombInstrumentID); d["LegID"] = a.LegID; d["LegInstrumentID"] = encoding_cast(a.LegInstrumentID); d["Direction"] = a.Direction; d["LegMultiple"] = a.LegMultiple; d["ImplyLevel"] = a.ImplyLevel; return d;});
	...
	py::class_<CThostFtdcInvestorPositionCombineDetailField>(m, "CThostFtdcInvestorPositionCombineDetailField")
		...
		.def("to_dict", [](const CThostFtdcInvestorPositionCombineDetailField& a) {py::dict d; d["TradingDay"] = encoding_cast(a.TradingDay); d["OpenDate"] = encoding_cast(a.OpenDate); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["SettlementID"] = a.SettlementID; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["ComTradeID"] = encoding_cast(a.ComTradeID); d["TradeID"] = encoding_cast(a.TradeID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["HedgeFlag"] = a.HedgeFlag; d["Direction"] = a.Direction; d["TotalAmt"] = a.TotalAmt; d["Margin"] = a.Margin; d["ExchMargin"] = a.ExchMargin; d["MarginRateByMoney"] = a.MarginRateByMoney; d["MarginRateByVolume"] = a.MarginRateByVolume; d["LegID"] = a.LegID; d["LegMultiple"] = a.LegMultiple; d["CombInstrumentID"] = encoding_cast(a.CombInstrumentID); d["TradeGroupID"] = a.TradeGroupID; d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcParkedOrderActionField>(m, "CThostFtdcParkedOrderActionField")
		...
		.def("to_dict", [](const CThostFtdcParkedOrderActionField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["OrderActionRef"] = a.OrderActionRef; d["OrderRef"] = encoding_cast(a.OrderRef); d["RequestID"] = a.RequestID; d["FrontID"] = a.FrontID; d["SessionID"] = a.SessionID; d["ExchangeID"] = encoding_cast(a.ExchangeID); d["OrderSysID"] = encoding_cast(a.OrderSysID); d["ActionFlag"] = a.ActionFlag; d["LimitPrice"] = a.LimitPrice; d["VolumeChange"] = a.VolumeChange; d["UserID"] = encoding_cast(a.UserID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ParkedOrderActionID"] = encoding_cast(a.ParkedOrderActionID); d["UserType"] = a.UserType; d["Status"] = a.Status; d["ErrorID"] = a.ErrorID; d["ErrorMsg"] = encoding_cast(a.ErrorMsg); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); d["IPAddress"] = encoding_cast(a.IPAddress); d["MacAddress"] = encoding_cast(a.MacAddress); return d;});
	...
	py::class_<CThostFtdcQryParkedOrderField>(m, "CThostFtdcQryParkedOrderField")
		...
		.def("to_dict", [](const CThostFtdcQryParkedOrderField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryParkedOrderActionField>(m, "CThostFtdcQryParkedOrderActionField")
		...
		.def("to_dict", [](const CThostFtdcQryParkedOrderActionField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryInvestorPositionCombineDetailField>(m, "CThostFtdcQryInvestorPositionCombineDetailField")
		...
		.def("to_dict", [](const CThostFtdcQryInvestorPositionCombineDetailField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["CombInstrumentID"] = encoding_cast(a.CombInstrumentID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcUserIPField>(m, "CThostFtdcUserIPField")
		...
		.def("to_dict", [](const CThostFtdcUserIPField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["UserID"] = encoding_cast(a.UserID); d["IPAddress"] = encoding_cast(a.IPAddress); d["IPMask"] = encoding_cast(a.IPMask); d["MacAddress"] = encoding_cast(a.MacAddress); return d;});
	...
	py::class_<CThostFtdcQueryMaxOrderVolumeWithPriceField>(m, "CThostFtdcQueryMaxOrderVolumeWithPriceField")
		...
		.def_property("BrokerID", [](const CThostFtdcQueryMaxOrderVolumeWithPriceField& a) {return encoding_cast(a.BrokerID);}, [](CThostFtdcQueryMaxOrderVolumeWithPriceField& a, char c[]) {strcpy(a.BrokerID, c);})
		.def_property("InvestorID", [](const CThostFtdcQueryMaxOrderVolumeWithPriceField& a) {return encoding_cast(a.InvestorID);}, [](CThostFtdcQueryMaxOrderVolumeWithPriceField& a, char c[]) {strcpy(a.InvestorID, c);})
		.def_property("InstrumentID", [](const CThostFtdcQueryMaxOrderVolumeWithPriceField& a) {return encoding_cast(a.InstrumentID);}, [](CThostFtdcQueryMaxOrderVolumeWithPriceField& a, char c[]) {strcpy(a.InstrumentID, c);})
		...
		.def_property("ExchangeID", [](const CThostFtdcQueryMaxOrderVolumeWithPriceField& a) {return encoding_cast(a.ExchangeID);}, [](CThostFtdcQueryMaxOrderVolumeWithPriceField& a, char c[]) {strcpy(a.ExchangeID, c);})
		.def_property("InvestUnitID", [](const CThostFtdcQueryMaxOrderVolumeWithPriceField& a) {return encoding_cast(a.InvestUnitID);}, [](CThostFtdcQueryMaxOrderVolumeWithPriceField& a, char c[]) {strcpy(a.InvestUnitID, c);})
		.def("to_dict", [](const CThostFtdcQueryMaxOrderVolumeWithPriceField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["Direction"] = a.Direction; d["OffsetFlag"] = a.OffsetFlag; d["HedgeFlag"] = a.HedgeFlag; d["MaxVolume"] = a.MaxVolume; d["Price"] = a.Price; d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryBrokerTradingAlgosField>(m, "CThostFtdcQryBrokerTradingAlgosField")
		...
		.def("to_dict", [](const CThostFtdcQryBrokerTradingAlgosField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InstrumentID"] = encoding_cast(a.InstrumentID); return d;});
	...
	py::class_<CThostFtdcBrokerTradingAlgosField>(m, "CThostFtdcBrokerTradingAlgosField")
		...
		.def("to_dict", [](const CThostFtdcBrokerTradingAlgosField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["HandlePositionAlgoID"] = a.HandlePositionAlgoID; d["FindMarginRateAlgoID"] = a.FindMarginRateAlgoID; d["HandleTradingAccountAlgoID"] = a.HandleTradingAccountAlgoID; return d;});
	...
	py::class_<CThostFtdcEWarrantOffsetField>(m, "CThostFtdcEWarrantOffsetField")
		...
		.def("to_dict", [](const CThostFtdcEWarrantOffsetField& a) {py::dict d; d["TradingDay"] = encoding_cast(a.TradingDay); d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["Direction"] = a.Direction; d["HedgeFlag"] = a.HedgeFlag; d["Volume"] = a.Volume; d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryEWarrantOffsetField>(m, "CThostFtdcQryEWarrantOffsetField")
		...
		.def("to_dict", [](const CThostFtdcQryEWarrantOffsetField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryInvestorProductGroupMarginField>(m, "CThostFtdcQryInvestorProductGroupMarginField")
		...
		.def("to_dict", [](const CThostFtdcQryInvestorProductGroupMarginField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["InvestorID"] = encoding_cast(a.InvestorID); d["ProductGroupID"] = encoding_cast(a.ProductGroupID); d["HedgeFlag"] = a.HedgeFlag; d["ExchangeID"] = encoding_cast(a.ExchangeID); d["InvestUnitID"] = encoding_cast(a.InvestUnitID); return d;});
	...
	py::class_<CThostFtdcQryProductGroupField>(m, "CThostFtdcQryProductGroupField")
		...
		.def("to_dict", [](const CThostFtdcQryProductGroupField& a) {py::dict d; d["ProductID"] = encoding_cast(a.ProductID); d["ExchangeID"] = encoding_cast(a.ExchangeID); return d;});
	...
	py::class_<CThostFtdcProductGroupField>(m, "CThostFtdcProductGroupField")
		...
		.def("to_dict", [](const CThostFtdcProductGroupField& a) {py::dict d; d["ProductID"] = encoding_cast(a.ProductID); d["ExchangeID"] = encoding_cast(a.ExchangeID); d["ProductGroupID"] = encoding_cast(a.ProductGroupID); return d;});
	...
	py::class_<CThostFtdcMulticastInstrumentField>(m, "CThostFtdcMulticastInstrumentField")
		...
		.def("to_dict", [](const CThostFtdcMulticastInstrumentField& a) {py::dict d; d["TopicID"] = a.TopicID; d["InstrumentID"] = encoding_cast(a.InstrumentID); d["InstrumentNo"] = a.InstrumentNo; d["CodePrice"] = a.CodePrice; d["VolumeMultiple"] = a.VolumeMultiple; d["PriceTick"] = a.PriceTick; return d;});
	...
	py::class_<CThostFtdcQryMulticastInstrumentField>(m, "CThostFtdcQryMulticastInstrumentField")
		...
		.def("to_dict", [](const CThostFtdcQryMulticastInstrumentField& a) {py::dict d; d["TopicID"] = a.TopicID; d["InstrumentID"] = encoding_cast(a.InstrumentID); return d;});
	...
	py::class_<CThostFtdcLoginForbiddenUserField>(m, "CThostFtdcLoginForbiddenUserField")
		...
		.def("to_dict", [](const CThostFtdcLoginForbiddenUserField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["UserID"] = encoding_cast(a.UserID); d["IPAddress"] = encoding_cast(a.IPAddress); return d;});
	...
	py::class_<CThostFtdcMulticastGroupInfoField>(m, "CThostFtdcMulticastGroupInfoField")
		...
		.def_property("GroupIP", [](const CThostFtdcMulticastGroupInfoField& a) {return encoding_cast(a.GroupIP);}, [](CThostFtdcMulticastGroupInfoField& a, char c[]) {strcpy(a.GroupIP, c);})
		.def_readwrite("GroupPort", &CThostFtdcMulticastGroupInfoField::GroupPort)
		.def_property("SourceIP", [](const CThostFtdcMulticastGroupInfoField& a) {return encoding_cast(a.SourceIP);}, [](CThostFtdcMulticastGroupInfoField& a, char c[]) {strcpy(a.SourceIP, c);})
		.def("to_dict", [](const CThostFtdcMulticastGroupInfoField& a) {py::dict d; d["GroupIP"] = encoding_cast(a.GroupIP); d["GroupPort"] = a.GroupPort; d["SourceIP"] = encoding_cast(a.SourceIP); return d;});
	...
	py::class_<CThostFtdcQryLoginForbiddenIPField>(m, "CThostFtdcQryLoginForbiddenIPField")
		...
		.def("to_dict", [](const CThostFtdcQryLoginForbiddenIPField& a) {py::dict d; d["IPAddress"] = encoding_cast(a.IPAddress); return d;});
	...
	py::class_<CThostFtdcQryIPListField>(m, "CThostFtdcQryIPListField")
		...
		.def("to_dict", [](const CThostFtdcQryIPListField& a) {py::dict d; d["IPAddress"] = encoding_cast(a.IPAddress); return d;});
	...
	py::class_<CThostFtdcUserSystemInfoField>(m, "CThostFtdcUserSystemInfoField")
		...
		.def("to_dict", [](const CThostFtdcUserSystemInfoField& a) {py::dict d; d["BrokerID"] = encoding_cast(a.BrokerID); d["UserID"] = encoding_cast(a.UserID); d["ClientSystemInfoLen"] = a.ClientSystemInfoLen; d["ClientSystemInfo"] = encoding_cast(a.ClientSystemInfo); d["ClientPublicIP"] = encoding_cast(a.ClientPublicIP); d["ClientIPPort"] = a.ClientIPPort; d["ClientLoginTime"] = encoding_cast(a.ClientLoginTime); d["ClientAppID"] = encoding_cast(a.ClientAppID); return d;});
	...
	py::class_<CThostFtdcReqUserLoginWithCaptchaField>(m, "CThostFtdcReqUserLoginWithCaptchaField")
		...
		.def("to_dict", [](const CThostFtdcReqUserLoginWithCaptchaField& a) {py::dict d; d["TradingDay"] = encoding_cast(a.TradingDay); d["BrokerID"] = encoding_cast(a.BrokerID); d["UserID"] = encoding_cast(a.UserID); d["Password"] = encoding_cast(a.Password); d["UserProductInfo"] = encoding_cast(a.UserProductInfo); d["InterfaceProductInfo"] = encoding_cast(a.InterfaceProductInfo); d["ProtocolInfo"] = encoding_cast(a.ProtocolInfo); d["MacAddress"] = encoding_cast(a.MacAddress); d["ClientIPAddress"] = encoding_cast(a.ClientIPAddress); d["LoginRemark"] = encoding_cast(a.LoginRemark); d["Captcha"] = encoding_cast(a.Captcha); d["ClientIPPort"] = a.ClientIPPort; return d;});
	...
	py::class_<CThostFtdcReqUserLoginWithTextField>(m, "CThostFtdcReqUserLoginWithTextField")
		...
		.def("to_dict", [](const CThostFtdcReqUserLoginWithTextField& a) {py::dict d; d["TradingDay"] = encoding_cast(a.TradingDay); d["BrokerID"] = encoding_cast(a.BrokerID); d["UserID"] = encoding_cast(a.UserID); d["Password"] = encoding_cast(a.Password); d["UserProductInfo"] = encoding_cast(a.UserProductInfo); d["InterfaceProductInfo"] = encoding_cast(a.InterfaceProductInfo); d["ProtocolInfo"] = encoding_cast(a.ProtocolInfo); d["MacAddress"] = encoding_cast(a.MacAddress); d["ClientIPAddress"] = encoding_cast(a.ClientIPAddress); d["LoginRemark"] = encoding_cast(a.LoginRemark); d["Text"] = encoding_cast(a.Text); d["ClientIPPort"] = a.ClientIPPort; return d;});
	...
	py::class_<CThostFtdcReqUserLoginWithOTPField>(m, "CThostFtdcReqUserLoginWithOTPField")
		...
		.def("to_dict", [](const CThostFtdcReqUserLoginWithOTPField& a) {py::dict d; d["TradingDay"] = encoding_cast(a.TradingDay); d["BrokerID"] = encoding_cast(a.BrokerID); d["UserID"] = encoding_cast(a.UserID); d["Password"] = encoding_cast(a.Password); d["UserProductInfo"] = encoding_cast(a.UserProductInfo); d["InterfaceProductInfo"] = encoding_cast(a.InterfaceProductInfo); d["ProtocolInfo"] = encoding_cast(a.ProtocolInfo); d["MacAddress"] = encoding_cast(a.MacAddress); d["ClientIPAddress"] = encoding_cast(a.ClientIPAddress); d["LoginRemark"] = encoding_cast(a.LoginRemark); d["OTPPassword"] = encoding_cast(a.OTPPassword); d["ClientIPPort"] = a.ClientIPPort; return d;});
	...
	py::class_<CThostFtdcAuthForbiddenIPField>(m, "CThostFtdcAuthForbiddenIPField")
		...
		.def("to_dict", [](const CThostFtdcAuthForbiddenIPField& a) {py::dict d; d["IPAddress"] = encoding_cast(a.IPAddress); return d;});
	...
	py::class_<CThostFtdcQryAuthForbiddenIPField>(m, "CThostFtdcQryAuthForbiddenIPField")
		...
		.def("to_dict", [](const CThostFtdcQryAuthForbiddenIPField& a) {py::dict d; d["IPAddress"] = encoding_cast(a.IPAddress); return d;});
